      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-11">
            ...
            <p className="blog-body">
              Starting this app, trying to create my own components and buttons was a struggle, and I’m sure it shows. I used pngs for my button images, which really fell apart when the screen size wasn’t exactly the size I was using in my emulator. Not to mention that the UI I came up with was not the best. Despite all this, I was very proud of what I had built, as it was the first real piece of more complex software I had built in my life.
            </p>
            <p className="blog-body">
