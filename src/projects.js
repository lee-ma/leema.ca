        ...
        <div className="container-fluid" style={{marginTop: "10em"}}>
          <div className="row">
            <div className="col-12">
              ...
              <div className="mobile-full"><Slide image={"../assets/zephyr-banner.svg"} color={"#FF8A65"} title="Zephyr" post="/zephyr" public={true} github="https://github.com/LeeMa9321/zephyr" live="http://lee-zephyr.herokuapp.com"/></div>
