        ...
        <div className="row">
          ...
          <div className="col-11 offset-md-1">
            ...
            <div>
              ...
              <p className="blog-body">For the backend, I used Express with Node.js to handle HTTP CRUD operations, and MongoDB to store user data. I utilized AWS S3 to store user profile pictures, and send a link to store in MongoDB, which allowed for better scalability for data storage.</p>
              <p className="blog-body">For the search I used simple text indexing in Mongoose to find search terms in the title and body of listings and return the ones that matched. This was a fairly elementary implementation of search, but for Atheneum, it was good enough to fill the search functionality. In my future projects, I will definitely look into trying to implement a search algorithm, probably based on a ranking system.</p>
              <img className="scrnshot" src="./assets/atheneum-pics/search.png"/>
              <p className="blog-body">
                For user authentication, I implemented email and password authentication, using bcrypt for password hashing and salting to protect user information. For Atheneum, I did not implement email verification, but for future projects, it is something I will be looking into with nodemailer, to ensure even greater account and user information security. Alongside, email and password authentication, I included social authentication for even simpler account creation. Using OAuth with Google and Facebook authentication, it allowed users to create an account with existing services they already use, and not have to give their passwords to me if they did not trust my site. It made creating an account as easy as clicking a button and allowing the app to access the user’s display name, and profile picture to use with Atheneum.
              </p>
              <img className="scrnshot" src="./assets/atheneum-pics/login.png"/>
              <h3 className="subheader">Conclusion</h3>
              <p className="blog-body">I think that I made fairly large strides from my last website (Who’s Right) with Atheneum. I created a more complex front-end that displayed larger amounts of information effectively, and implemented more features for the website as a whole. Overall, I was very happy with the way it turned out, and I learned a lot along the way.</p>
